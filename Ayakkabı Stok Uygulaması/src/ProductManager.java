...
public class ProductManager {
    ...
    public static void siparisKaydet(String kullaniciAdi, Product urun, int adet) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(SIPARIS_DOSYA, true))) {
            ...
            bw.write(kullaniciAdi + "," + urun.getKod() + "," + urun.getModel() + "," + 
    ...
    private static void ilkUrunleriOlustur() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(URUN_DOSYA))) {
            ...
            bw.write("N001,Nike,Spor,Air Max 270,37,15,2499.90,Günlük kullanım için rahat spor ayakkabı");
            bw.newLine();
            bw.write("N002,Nike,Spor,Revolution 6,38,20,1899.90,Koşu ve antrenman için ideal");
            bw.newLine();
            bw.write("N003,Nike,Spor,Court Vision,39,12,1799.90,Basketbol tarzı günlük ayakkabı");
            bw.newLine();
            
            bw.write("N004,Nike,Koşu,Pegasus 40,37,8,3299.90,Profesyonel koşu ayakkabısı");
            bw.newLine();
            bw.write("N005,Nike,Koşu,Downshifter 12,38,18,1599.90,Başlangıç seviyesi koşu ayakkabısı");
            bw.newLine();
            bw.write("N006,Nike,Koşu,React Infinity,39,10,3599.90,Uzun mesafe koşu için");
            bw.newLine();
            
            bw.write("N007,Nike,Casual,Air Force 1,37,25,2999.90,Klasik streetwear ayakkabı");
            bw.newLine();
            bw.write("N008,Nike,Casual,Blazer Mid,38,14,2699.90,Retro tasarım günlük ayakkabı");
            bw.newLine();
            bw.write("N009,Nike,Casual,Dunk Low,39,9,2899.90,Sokak modasının ikonu");
            bw.newLine();
            
           
            bw.write("A001,Adidas,Spor,Superstar,37,22,2299.90,Efsanevi shell toe tasarım");
            bw.newLine();
            bw.write("A002,Adidas,Spor,Grand Court,38,16,1699.90,Tenis tarzı günlük ayakkabı");
            bw.newLine();
            bw.write("A003,Adidas,Spor,Stan Smith,39,19,2199.90,Minimalist klasik tasarım");
            bw.newLine();
            
            bw.write("A004,Adidas,Koşu,Ultraboost 23,37,11,4299.90,Premium koşu performansı");
            bw.newLine();
            bw.write("A005,Adidas,Koşu,Solar Glide,38,13,2799.90,Uzun mesafe konforu");
            bw.newLine();
            bw.write("A006,Adidas,Koşu,Duramo SL,39,17,1499.90,Bütçe dostu koşu ayakkabısı");
            bw.newLine();
            
            bw.write("A007,Adidas,Casual,Gazelle,37,20,2399.90,Vintage süet tasarım");
            bw.newLine();
            bw.write("A008,Adidas,Casual,Samba,38,15,2499.90,Futsal tarzı günlük ayakkabı");
            bw.newLine();
            bw.write("A009,Adidas,Casual,Forum Low,39,12,2599.90,90'lar basketbol estetiği");
            bw.newLine();
            
            
            bw.write("NB001,New Balance,Spor,574 Core,37,18,2199.90,İkonik retro running tasarım");
            bw.newLine();
            bw.write("NB002,New Balance,Spor,327,38,21,2399.90,70'lerin klasik koşu estetiği");
            bw.newLine();
            bw.write("NB003,New Balance,Spor,480,39,14,1899.90,Basketbol esinli günlük ayakkabı");
            bw.newLine();
            
            bw.write("NB004,New Balance,Koşu,Fresh Foam 1080,37,9,3799.90,Premium koşu yastıklama");
            bw.newLine();
            bw.write("NB005,New Balance,Koşu,FuelCell Rebel,38,16,2999.90,Hafif ve hızlı koşu ayakkabısı");
            bw.newLine();
            bw.write("NB006,New Balance,Koşu,880 v12,39,11,2599.90,Günlük antrenman için ideal");
            bw.newLine();
            
            bw.write("NB007,New Balance,Casual,550,37,13,2899.90,Vintage basketbol silüeti");
            bw.newLine();
            bw.write("NB008,New Balance,Casual,2002R,38,17,2699.90,Y2K estetiği modern konfor");
            bw.newLine();
            bw.write("NB009,New Balance,Casual,9060,39,15,3199.90,Chunky retro hybrid tasarım");
            bw.newLine();
            
            System.out.println("Örnek ürünler oluşturuldu: urunler.txt");
        } catch (IOException e) {
